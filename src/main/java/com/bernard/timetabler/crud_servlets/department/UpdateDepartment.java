...
public class UpdateDepartment extends HttpServlet {
	...
	private boolean updateDepart(DepartmentRequest req) throws SQLException {
		String updateQuery = "UPDATE " + TABLE_DEPARTMENTS
				+ " SET " + DEPARTMENT_NAME + "='" + req.getDepartment().getDepartmentName()+ "'"
				+ "," + FACULTY_ID + "='" + req.getDepartment().getFacultyId() + "'"
				+ " WHERE " + DEPARTMENT_ID + "='" + req.getDepartment().getDepartmentId() + "'";
