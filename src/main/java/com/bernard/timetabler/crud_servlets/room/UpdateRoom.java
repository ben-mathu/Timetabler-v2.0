...
public class UpdateRoom extends HttpServlet {
	...
	private boolean updateRoom(RoomRequest req, String classId) throws SQLException {
		...
		String updateQuery = "UPDATE " + TABLE_CLASSES
				+ " SET " + CLASS_ID + "='" + newClassId + "'"
				+ " , " + FACULTY_ID + "='" + req.getRoom().getFacultyId() + "'"
				+ " , " + HALL_ID + "='" + req.getRoom().getHall_id() + "'"
				+ " , " + VOLUME + "='" + req.getRoom().getVolume() + "'"
				+ " , " + IS_LAB + "=" + req.getRoom().isLab()
				+ " , " + AVAILABILITY + "=" + req.getRoom().isLab()
